...
#define FFMPEG_CONFIGURATION "--pkg-config-flags=--static --disable-doc --enable-pthreads --enable-debug=2 --disable-nvenc --disable-libx265 --enable-decoder=hevc --enable-parser=hevc --enable-demuxer=hevc --disable-vaapi"
